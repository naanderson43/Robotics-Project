...
//-------------------------------------------------------------------------------
void Home(void){
  ShoulderLift(SHOULDER_LIFT_HOME, PWM_MAX / 2);
  Elbow(ELBOW_HOME, PWM_MAX);
  Wrist(WRIST_HOME, 115);
  ShoulderRot(SHOULDER_ROT_HOME, PWM_MAX / 2);
...
//-------------------------------------------------------------------------------
void LeftTurn(void){
  ShoulderLift(SHOULDER_LIFT_HOME, 150);
  ShoulderRot(SHOULDER_ROT_HOME, 115);
  Gripper(GRIPPER_CLOSED, 128);
  Elbow(250, 128);
  Wrist(250, 100);
  ShoulderLift(675, 255);
  ShoulderRot(535, 255);
  ShoulderLift(SHOULDER_LIFT_HOME, 150);
  ShoulderRot(SHOULDER_ROT_HOME, 115);
}
